...
Das "input" Bild muss volgende Voraussetzungen erfüllen: \\
\begin{itemize}
  \item Die Bücher sollen alle einen gleichen Label haben. 
  \item Die Bücher auf dem Bild sollen gerade stehen (senkrecht zur Schrankebene)
  \item Die Auflösung und Helligkeit des Bildes ist so zu wählen, dass das Label von dem Buch erkennbar und die Ziffern und Buchstaben am Label lesbar sind.
  \item Das input bild soll möglichst senkrecht zu Schrankebene gemacht sein.
\end{itemize}
